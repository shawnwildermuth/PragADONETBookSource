...
namespace BookExamples {
    ...
    public class _CustomerTDS : DataSet {
        ...
        protected _CustomerTDS(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            _CustomerTDS cln = ((_CustomerTDS)(base.Clone()));
            cln.InitVars();
            return cln;
        }
